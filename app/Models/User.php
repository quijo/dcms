 ...
 * @property-read int|null $effective_church_id
...
class User extends Authenticatable
{
    ...
    {
        return $this->hasOne(Pastor::class, 'email', 'email');
    }

    public function getEffectiveChurchIdAttribute(): ?int
    {
        return $this->church_id ?? $this->pastor?->church_id;
    }
}
